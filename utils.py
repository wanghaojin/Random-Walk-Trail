...
def load_data(dataset):
    ...
    return adj, features, np.argmax(labels, 1) #读取数据集
...
def laplacian(adj):
    ...
    lap = degree_mat - adj
    return torch.FloatTensor(lap.toarray()) #计算拉普拉斯矩阵
